...
// Inject CloudLLM as default (cloud workers for embeddings/reranking, local fallback)
setDefaultLlamaCpp(new CloudLLM());
console.log("[QMD] CloudLLM initialized - using workers for embeddings/reranking");
